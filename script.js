...
function createMemberCard(member) {
    ...
    card.innerHTML = `
        <div class="member-avatar">
            <img src="${member.avatar}" alt="${member.nickname}" onerror="this.onerror=null; this.src='https://via.placeholder.com/70/2a2a2a/888?text=' + encodeURIComponent('${member.nickname.charAt(0)}')">
        </div>
    ...
    container.innerHTML = `
        <div class="profile-header">
            <div class="profile-avatar">
                <img src="${member.avatar}" alt="${member.nickname}" onerror="this.onerror=null; this.src='https://via.placeholder.com/120/2a2a2a/fff?text=' + encodeURIComponent('${member.nickname.charAt(0)}')">
            </div>
